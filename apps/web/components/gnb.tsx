  ...
  return (
    <>
      ...
      <div className="w-full bg-[#121212] text-white fixed top-0 left-0 h-[70px] shadow-[0_10px_8px_0_rgba(0,0,0,0.2)] z-10 hidden md:block">
        <div className="flex items-center justify-between h-full px-[20px] w-full">
          <div className="flex items-center h-full">
            <h1 className="m-0 flex items-center h-full">LOGO</h1>
      ...
      <div className="fixed bottom-0 left-0 w-full h-[70px] bg-[#121212] border-t border-[#383838] md:hidden flex items-center z-10">
        <Link href="/" className="flex-1 flex flex-col items-center justify-center h-full">
          <div className="flex items-center justify-center">
            <Icons.home width={24} height={24} fill={isActive('/') ? 'white' : '#A3A3A3'} />
          </div>
          <span className={`text-xs mt-1 ${isActive('/') ? 'text-white' : 'text-[#A3A3A3]'}`}>
            Home
          </span>
        </Link>
        <Link
        ...
        <Link href="/game-list" className="flex-1 flex flex-col items-center justify-center h-full">
          <div className="flex items-center justify-center">
            <Icons.game
              width={24}
              height={24}
        ...
        <Link href="/ai-main" className="flex-1 flex flex-col items-center justify-center h-full">
          <div className="flex items-center justify-center">
